...
inputs = {
  ...
  provider_aws_green_region = local.partition.shared.provider.aws.region["green"].region
  provider_aws_blue_region  = local.partition.shared.provider.aws.region["blue"].region
}
